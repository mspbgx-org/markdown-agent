...
if __name__ == "__main__":
    print("\n🔖 Markdown Agent - Your Markdown File Assistant!")
    print("I can help you read, create, and edit Markdown files.")
    ...
    while True:
        ...
        if user_input.lower() == "exit":
            print("Happy writing! 📝")
            break
        response = markdown_agent(user_input)
        print(f"\nmarkdown_agent > {response}")
